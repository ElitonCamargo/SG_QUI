...
--
-- Host: localhost:3306
-- Tempo de geração: 01/04/2024 às 21:31
...
CREATE TABLE `cliente` (
  ...
  `cnpj_cpf` bigint UNSIGNED DEFAULT NULL,
...
--
-- Estrutura para tabela `composto`
--
...
CREATE TABLE `composto` (
  ...
  `nome` varchar(100) DEFAULT NULL,
  `formnula` varchar(100) DEFAULT NULL,
  `cas_number` varchar(100) DEFAULT NULL,
  `densidade` decimal(10,5) DEFAULT NULL,
...
CREATE TABLE `garantia` (
  ...
  `composto` int UNSIGNED DEFAULT NULL,
  `elemento` tinyint UNSIGNED DEFAULT NULL,
  `percentual` double(6,3) DEFAULT NULL,
  `createdAt` datetime DEFAULT CURRENT_TIMESTAMP,
  `updatedAt` datetime DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
